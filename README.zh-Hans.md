...
通过 `@Service` 属性包装器实现优雅的依赖注入，使用熟悉的 register/resolve 模式。专为 Swift 6 并发模型打造，基于 TaskLocal 实现环境隔离。几分钟即可上手。
...
- **[服务组装](https://nslogmeng.github.io/swift-service/zh-Hans/documentation/service/serviceassembly/?utm_source=github&utm_medium=referral&utm_campaign=service-github&utm_content=readme-docs)** - 组织服务注册
- **[错误处理](https://nslogmeng.github.io/swift-service/zh-Hans/documentation/service/errorhandling/?utm_source=github&utm_medium=referral&utm_campaign=service-github&utm_content=readme-docs)** - 处理服务解析错误
